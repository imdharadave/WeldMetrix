...
export default function Footer() {
  ...
  return (
    <div className="relative bg-black">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t :border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div>
              {" "}
              <Link href="/about" className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                    {/* <Image
                      src="/img/logo.svg"
                      alt=""
                      width="32"
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright © {new Date().getFullYear()}. Made with Manami Solutions LLP.{" "}
          {/* <a
